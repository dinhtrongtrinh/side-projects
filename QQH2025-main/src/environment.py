...
class Environment:
    ...
    odds_cols = ["OddsH", "OddsA", "OddsD"]

    bet_cols = ["BetH", "BetA", "BetD"]

    # fmt: off
    feature_cols = [
        "HS", "AS", "Special", "H_PEN", "A_PEN", "H_MAJ",
        "A_MAJ", "H_PPG", "A_PPG", "H_SHG", "A_SHG", "H_SV", "A_SV", "H_PIM",
        "A_PIM", "H_SOG", "A_SOG", "H_BLK_S", "A_BLK_S", "H_HIT", "A_HIT",
        "H_BLK", "A_BLK", "H_FO", "A_FO", "H_P1", "A_P1", "H_P2", "A_P2",
        "H_P3", "A_P3", "H_OT", "A_OT", "H_SO", "A_SO"
    ]
    # fmt: on
    ...
    def _next_date(self, date: pd.Timestamp):
        ...
        return games.drop(["Open", *self.bet_cols], axis=1)
    ...
    def _get_options(self, date: pd.Timestamp):
        ...
        return opps.drop([*self.result_cols, *self.feature_cols, "Open"], axis=1)
